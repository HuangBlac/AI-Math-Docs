...
[4 页新稿](ch7.3-7.4-kernels-algorithms.md)实际对应 §7.3.3、§7.4.3–7.4.4，见[来源记录](handwritten-import-20260911.md)。Ex7.10 已有采样分布与期望推导，有限维向量归一化未写；Ex7.11 (a) 停在条件数比较的开头，(b) 未写。平方损失推导混用两种尺度，保留为错误待修订。均为 `note_unverified`，不改变学习账本。下面历史记录保留当日材料范围。

## 2026-09-10 新增 Ch7.2–7.3 原稿

新增来源为用户于 2026-09-09 提供的 7 页手写稿。见[新笔记](ch7.2-representer-kernel-foundations.md)与[导入记录](handwritten-import-20260910.md)。以下状态更新不改变学习账本，也不表示全节已掌握。
