...
> 状态：`note_unverified`。由 2026-09-09 提供的《Ch7.2-7.3.pdf》7 页整理，2026-09-10 导入。覆盖 §7.2、§7.3 核基础、§7.3.2 的 Fourier 特征起步，以及 Ex 7.1、7.2、7.6。难辨语句据上下文和锁定教材整理；原稿停止的证明和有问题的习题尝试均保留原状。
