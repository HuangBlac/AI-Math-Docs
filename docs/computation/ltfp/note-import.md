...
正文位于 `docs/computation/ltfp/`。补充材料接续现有章节标题，按概念和习题插入对应位置，不另开按日期命名的补充正文页；仅在没有对应章节且形成独立主题时新增页面，并更新[章节总览](index.md)、[覆盖映射](study-map.md)与站点导航。
...
- [2026-09-11：Sobolev、随机特征与对偶算法补充](handwritten-import-20260911.md)
